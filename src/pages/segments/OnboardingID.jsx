...
function OnboardingID({ nextStep, photoType, photoRef, passportPhoto, idFrontPhoto, idBackPhoto, onUpload }) {
                                ...
                                <div>
                                    <div className="d-inline-block position-relative w-auto mx-auto my-3">
                                        ...
                                        <div className="position-absolute bottom-0 end-0 z-index-1 h-auto">
                                            <button type='button' className="btn btn-lg btn-theme btn-square">
