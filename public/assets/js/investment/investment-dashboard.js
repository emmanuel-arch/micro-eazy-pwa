...
document.addEventListener("DOMContentLoaded", (function() {
    ...
    t.addColorStop(0, "rgba(23, 94, 100, 1)"), t.addColorStop(1, "rgba(23, 94, 100, 0)");
    var o = {
            type: "bar",
            data: {
    ...
    e.addColorStop(0, "rgba(23, 94, 100, 0.85)"), e.addColorStop(1, "rgba(23, 94, 100, 0)");
    var d = {
            type: "line",
            data: {
    ...
    new Chart(c, {
        ...
        data: {
            ...
            datasets: [{
                ...
                data: [40, 35, 15, 25, 20],
                backgroundColor: ["#6faa00", "#ffc107", "#fd7e14", "#473c38", "#becede"],
                borderWidth: 0
            }]
        },
        options: {
