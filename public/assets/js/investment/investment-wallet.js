...
document.addEventListener("DOMContentLoaded", (function() {
    ...
    var a = document.getElementById("areachartblue1").getContext("2d"),
        o = a.createLinearGradient(0, 0, 0, 300);
    o.addColorStop(0, "rgba(23, 94, 100, 1)"), o.addColorStop(1, "rgba(23, 94, 100, 0)");
    var r = a.createLinearGradient(0, 0, 0, 280);
    r.addColorStop(0, "rgba(23, 94, 100, 0.5)"), r.addColorStop(1, "rgba(23, 94, 100, 0)");
    var n = {
            type: "bar",
            data: {
    ...
    setInterval((function() {
        n.data.datasets.forEach((function(a) {
